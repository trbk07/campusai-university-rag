...
`phase4_basic_rag.jsonl` is the Basic RAG acceptance set. It contains 30
university-fixture questions with answerable, multi-evidence, ambiguous and
out-of-corpus cases. Its report is generated by
`evaluation/run_phase4_basic_rag.py`, which builds the fixture corpus at
runtime and uses a deterministic offline LLM contract double.
