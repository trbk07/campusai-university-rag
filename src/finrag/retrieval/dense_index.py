...
class DenseIndex:
    ...
    def __init__(self, items: list[dict] | None = None, model_name: str = "fallback-hash-256") -> None:
        self.items = items or []
    ...
    def to_dict(self) -> dict:
        return {"model_name": self.model_name, "items": self.items, "vectors": self.vectors}
    ...
    def load(cls, path: str | Path) -> "DenseIndex":
        ...
        index = cls(data["items"], data.get("model_name", "fallback-hash-256"))
